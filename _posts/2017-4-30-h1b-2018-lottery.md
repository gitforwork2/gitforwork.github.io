...
Here is the summary of activities expected from USCIS,

USCIS Activity | What it means | 2017 | 2016
---------------|---------------|------|-----
Encashing the check | USCIS encashes the check (H1b fees) for petitions selected in the lottery | People have reported that checks are being encashed | |
H1b receipts | USCIS starts sending H1b receipt number for candidates selected in the lottery | People have reported H1b receipts | |
Data Entry | USCIS completes data entry of lottery selected petitions. At this time USCIS starts returning un-selected petitions | ?? | May 2, 2016 |
